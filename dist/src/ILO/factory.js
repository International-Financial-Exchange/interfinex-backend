...
class Factory {
    ...
    getIloDetails(simpleIloDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, simpleIloDetails), { assetTokenAmount: yield iloContract.methods.assetTokenAmount().call(), assetToken, startDate: parseInt(yield iloContract.methods.startDate().call()), endDate: parseInt(yield iloContract.methods.endDate().call()), percentageToLock: yield iloContract.methods.percentageToLock().call(), liquidityUnlockDate: parseInt(yield iloContract.methods.liquidityUnlockDate().call()), creationDate: parseInt(yield iloContract.methods.creationDate().call()), creator: yield iloContract.methods.creator().call(), hasEnded: yield iloContract.methods.hasEnded().call(), 
    ...
    addIlo(iloId) {
        return __awaiter(this, void 0, void 0, function* () {
            const simpleIloDetails = yield this.getIloSimpleDetails(iloId);
            ...
            yield collections_1.ILO_COLLECTIONS.iloListCollection.updateOne({ contractAddress: simpleIloDetails.contractAddress }, { "$set": iloDetails }, { upsert: true });
    ...
    startIloCreationListener() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.factoryContract.events.NewILO()
                .on("data", ({ returnValues: { id } }) => __awaiter(this, void 0, void 0, function* () {
